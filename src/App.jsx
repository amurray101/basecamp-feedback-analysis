  ...
  return (
    <>
      ...
      <div style={sectionStyle}>
        ...
        <p style={pStyle}>Before the curriculum splits into role-specific tracks, every participant goes through a shared foundation: an overview of Anthropic's product suite — Claude, the API, Claude for Enterprise — and a comprehensive, hands-on introduction to Claude Code itself. The goal is to get everyone on the same page. A PE, an SA, and a researcher all need to understand the agentic architecture, the permission model, CLAUDE.md conventions, and the extension points before they can apply them differently in their roles. This common core establishes the shared vocabulary and mental model that the rest of the program builds on.</p>
      </div>
